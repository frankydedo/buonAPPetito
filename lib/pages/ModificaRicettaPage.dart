...
Future showConfermaDialog ()
{
  ...
  void generaDifficoltaInAutomatico() {
    ...
    //
    // se ne calcola la media pesata e si arrotonda (e.g. 3.51 --> 4 , 3.49 --> 3 , 3.50 --> 3)
    setState(() {
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                              ...
                                              border: Border.all(
                                                width: 1.5,
                                                color: difficolta == 0 ? colorsModel.coloreSecondario : Colors.transparent
                                              )
                                            ),
                                            child: ListTile(
                                              title: Row(
